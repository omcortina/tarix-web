...
<head>
    ...
    <title>Editar Usuario Empresa | Admin TARIX</title>
    ...
    <style>
        ...
        .form-info { background: #fff3e0; color: #e65100; padding: 16px; border-radius: 8px; margin-bottom: 24px; font-size: 14px; line-height: 1.6; }
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-header">
            <h1 class="page-title">Editar Usuario Empresa</h1>
        ...
        <div class="form-card">
            ...
            <div class="form-info">
                ...
                Puedes actualizar los datos del usuario empresa y restablecer su contraseña. Si cambias la contraseña, el usuario deberá cambiarla en su próximo inicio de sesión.
            </div>

            <form method="POST" action="{{ route('admin.users.update-empresa', $user) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-actions" style="gap: 12px; margin-top: 32px;">
