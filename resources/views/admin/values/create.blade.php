...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="form-header">
            ...
            <p>Completa los datos del valor para agregarlo a la sección de valores</p>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 320px; gap: 24px;">
            <form class="form-card" method="POST" action="{{ route('admin.values.store') }}">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Precisión arancelaria" required>
                        <div class="hint">Se traducirá automáticamente al inglés</div>
                    </div>

                    <div class="form-group full">
                        <label for="description">Descripción *</label>
                        <textarea id="description" name="description" placeholder="Descripción del valor..." required>{{ old('description') }}</textarea>
                        <div class="hint">Se traducirá automáticamente al inglés</div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group full">
                        ...
                        <input type="color" id="icon_color" name="icon_color" value="{{ old('icon_color', '#2a9d8f') }}" required>
                        <div class="hint">Elige el color de fondo del icono</div>
                    </div>

                    <div class="form-group full">
                        <label for="icon_svg">SVG del Icono *</label>
                        <textarea id="icon_svg" name="icon_svg" placeholder="Pega aquí solo las etiquetas del icono (paths, circles, etc)" required>{{ old('icon_svg') }}</textarea>
            ...
            <div class="form-card" style="position: sticky; top: 100px; height: fit-content;">
                ...
                <div id="preview" style="text-align: center;">
                    <div id="icon-preview" style="width: 80px; height: 80px; margin: 0 auto 20px; background-color: #2a9d8f; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    ...
                    <h6 id="preview-name" style="font-weight: 700; color: #1a2e44; margin-bottom: 10px;">Nombre del Valor</h6>
                    <p id="preview-desc" style="font-size: 13px; color: #6b7c93; line-height: 1.5;">Descripción del valor</p>
                </div>
            </div>
        </div>
    </div>
