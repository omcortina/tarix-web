...
<head>
    ...
    <title>Pago Verificado - TARIX</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .success-box { background-color: #e8f5e9; border-left: 4px solid #43a047; padding: 20px; margin: 20px 0; border-radius: 4px; }
        .success-box h3 { color: #1a2e44; font-size: 16px; margin-bottom: 15px; margin-top: 0; }
        ...
        .verified-badge { display: inline-block; background-color: #43a047; color: white; padding: 6px 16px; border-radius: 20px; font-weight: 700; font-size: 13px; margin: 5px 0; }
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="greeting">
                ...
                <p>El pago de una clasificación de tu empresa ha sido verificado. El proceso de clasificación ha iniciado.</p>
            </div>

            <center>
                <span class="verified-badge">Pago Confirmado</span>
            </center>

            <div class="client-box">
                <h4>Usuario asociado</h4>
        ...
        <div class="footer">
            ...
            <p>Este correo fue enviado porque se verificó el pago de una clasificación de tu empresa.</p>
