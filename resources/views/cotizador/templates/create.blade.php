...
<div class="admin-page-header">
    <h1 class="admin-page-title">Nueva Plantilla</h1>
...
<div class="form-card">
    <form action="{{ route('cotizador.templates.store') }}" method="POST" id="templateForm">
        @csrf

        <div class="form-group">
            <label class="form-label">Nombre interno de la plantilla <span class="required">*</span></label>
            <input type="text" name="name" class="form-input @error('name') is-invalid @enderror"
                value="{{ old('name') }}" placeholder="Ej: Propuesta Inicial, Seguimiento de Cotización..."
        ...
        <div class="form-group">
            ...
            <input type="text" name="subject" class="form-input @error('subject') is-invalid @enderror"
                value="{{ old('subject') }}" placeholder="Ej: Propuesta comercial - TARIX"
        ...
        <div class="form-group">
            ...
            <div id="quill-editor" style="min-height:300px;">{{ old('body') }}</div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn-primary">
                <i class="fa fa-save"></i> Guardar Plantilla
            </button>
...
<script>
    ...
    // Cargar contenido previo si existe (old value)
